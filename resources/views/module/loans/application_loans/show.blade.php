        ...
        <table class="table table-bordered table-striped logs">
            ...
            <div class="col-mb-12">
                <div class="mb-3 mt-3">
                    @if ($loan->status_id == 1)
                    @can('analyst_approve')
                    <a href="{{route('loans.approveAnalyst',$loan->id)}}" class="btn btn-primary">Analyst Approval</a>
                    <a href="{{route('loans.approveAnalyst',$loan->id)}}" class="btn btn-secondary">Analyst Reject</a>
                    @endcan
                    @elseif($loan->status_id == 2)
                    @can('ceo_approve')
                    <a href="{{route('loans.approveCeo',$loan->id)}}" class="btn btn-success">CEO Approval</a>
                    <a href="{{route('loans.approveAnalyst',$loan->id)}}" class="btn btn-secondary">CEO Reject</a>
                    @endcan
                    @elseif($loan->status_id == 4)
                    @can('sending_money')
                    <a href="{{route('loans.sendingMoney',$loan->id)}}" class="btn btn-success">Send Money</a>
                    @endcan
                    @endif
