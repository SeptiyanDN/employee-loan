...
@section('content')
    ...
    <div class="search-input">
        <a href="{{route('pemasukan.create')}}" class="btn btn-primary btn-sm">Tambah Transaksi Baru</a>
...
@includeIf('module.kelolakas.pemasukan.detail')
@endsection
@push('scripts')
<script>
  let table;
    ...
    function detailPemasukan(url){
        $('#modal-form').modal('show');
        $('#modal-form .modal-title').text('Detail Pemasukan');
