...
class DeskripsiPengeluaranSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        [
            'kode_transaksi' => '1-11011',
            'deskripsi_pengeluaran' => 'Pembelian Peralatan Untuk Usaha',
        ],
        [
            'kode_transaksi' => '1-11012',
            'deskripsi_pengeluaran' => 'Biaya Sewa Kios'
        ],
        [
            'kode_transaksi' => '1-11013',
            'deskripsi_pengeluaran' => 'Biaya Uang kebersihan Kios'
        ],
        [
